...
public class Pokemon {
    ...
    @SerializedName("mSpeciesHolder")
    @Expose
    private SpeciesHolder mSpeciesHolder;
    ...
    public SpeciesHolder getSpeciesHolder() {
        return mSpeciesHolder;
    }

    public void setSpeciesHolder(SpeciesHolder speciesHolder) {
        this.mSpeciesHolder = speciesHolder;
    }
